...
class Window(QMainWindow):
    ...
    def __init__(self):
        ...
        #self.m_ui.comboBox_6.currentTextChanged.connect(self.data_type_1_fun)
        data = np.empty(300)
    ...
    def update(self):
        ...
        try:
             ...
             if len(data)>0:
                  ...
                  self.Data = data
                  self.Data1 = np.array(self.Data[chN])
                  self.Data2 = np.array(self.Data[chN]/np.mean(self.Data[chN]))
                  self.allanData(self.Data1, self.rate_, 'freq', self.curve1)
                  self.allanData(self.Data2, self.rate_, 'freq', self.curve2)
    ...
    def f_ceo(self, data):
        ...
        #self.m_ui.comboBox_f_ceo.currentText() = chN
        try:
    ...
    def f_beat(self, data):
        global f_beat_
        chN = self.m_ui.comboBox_f_beat.currentText()
        #self.m_ui.comboBox_f_beat.currentText() = chN
        try:
